...
const Footer = () => {
  return (
    <div className="bg-primary-1 py-10">
      <div className="mx-auto w-10/12 max-w-7xl">
        ...
        <div className="mt-10 grid gap-6 text-white lg:grid-cols-4  lg:place-items-start">
          <div className="flex flex-col gap-2">
            ...
            <div className="flex items-center gap-2">
              <img src="/images/icon-email.svg" alt="icon-wmail" />
          ...
          <div className="flex flex-col gap-2">
            <Link href="/">
              <a className="transition-all duration-200 hover:text-accent-1">
                About Us
              </a>
            </Link>
            <Link href="/">
          ...
          <div className="flex items-center justify-center gap-2 lg:items-start lg:justify-end">
            <Link href="/">
              <a className="rounded-full border border-white p-2">
            ...
            <Link href="/">
              <a className="rounded-full border border-white p-2">
                <img src="/images/icon-twitter.svg" alt="twt" />
              </a>
            </Link>
