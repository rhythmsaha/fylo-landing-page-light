    ...
    <div className="mx-auto mt-10 flex w-10/12 flex-col gap-8 md:max-w-6xl lg:max-w-7xl lg:flex-row-reverse lg:items-center">
      ...
      <div className="space-y-8">
        ...
        <div className="flex flex-col gap-4 lg:flex-row">
          ...
          />
          <button className="w-full rounded bg-accent-1 px-3 py-3 font-raleway text-sm tracking-wider text-white transition-all duration-200 hover:bg-blue-500 lg:w-80">
            Get Started
          </button>
        </div>
      </div>
